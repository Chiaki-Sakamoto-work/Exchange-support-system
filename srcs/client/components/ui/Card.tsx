...
function Card({
  ...
  size?: 'default' | 'sm' | 'xs';
  variant?: 'default' | 'shadow-none' | 'destructive';
}) {
  return (
    <div
      data-slot='card'
      ...
      className={cn(
        'group/card flex flex-col overflow-hidden rounded-[16px] text-sm',

        'data-[variant=default]:bg-card data-[variant=default]:text-card-foreground',
        'data-[variant=default]:ring-1 data-[variant=default]:ring-inset data-[variant=default]:ring-card-foreground/[8%]',
        'data-[variant=default]:shadow-[0px_5.89px_17.66px] data-[variant=default]:shadow-card-foreground/[8%]',

        'data-[variant=shadow-none]:bg-card data-[variant=shadow-none]:text-card-foreground',

        'data-[variant=destructive]:bg-destructive/10 data-[variant=destructive]:text-destructive',
        'data-[variant=destructive]:ring-1 data-[variant=destructive]:ring-inset data-[variant=destructive]:ring-destructive/20',
        ...
        'data-[size=xs]:w-20 data-[size=xs]:h-6 data-[size=sm]:gap-2 data-[size=xs]:py-2',
